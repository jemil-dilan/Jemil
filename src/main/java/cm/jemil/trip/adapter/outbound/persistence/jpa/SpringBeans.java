...
import cm.jemil.trip.adapter.outbound.persistence.jpa.repository.JpaDemoRepository;
import cm.jemil.trip.adapter.outbound.persistence.jpa.repository.TripDemoSpringRepository;
...
public class SpringBeans {
    ...
    public DemoRepository demoRepository(
            TripDemoSpringRepository demoSpringRepository, TripDemoJpaMapper demoJpaMapper) {
