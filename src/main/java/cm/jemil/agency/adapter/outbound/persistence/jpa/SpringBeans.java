...
@EntityScan(basePackages = {"cm.jemil.agency.adapter.outbound.persistence.jpa.entity"})
@EnableJpaRepositories(basePackages = {"cm.jemil.agency.adapter.outbound.persistence.jpa.repository"})
