...
import cm.jemil.ticket.adapter.outbound.persistence.jpa.repository.JpaDemoRepository;
import cm.jemil.ticket.adapter.outbound.persistence.jpa.repository.TicketDemoSpringRepository;
import cm.jemil.ticket.adapter.outbound.persistence.jpa.repository.mapper.TicketDemoJpaMapper;
