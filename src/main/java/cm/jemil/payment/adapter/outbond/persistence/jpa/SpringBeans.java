...
@EntityScan(basePackages = {"cm.jemil.payment.adapter.outbond.persistence.jpa.entity"})
@EnableJpaRepositories(basePackages = {"cm.jemil.payment.adapter.outbond.persistence.jpa.repository"})
