...
@ConfigurationParameters({
    @ConfigurationParameter(key = "cucumber.glue", value = "cm.jemil.agency.e2e"),
    @ConfigurationParameter(
            key = "cucumber.plugin",
            value =
                    "pretty, json:build/cucumber-reports/agency-report.json, html:build/cucumber-reports/agency-report.html"),
