 ...
 */
@AnalyzeClasses(packages = "cm.jemil.agency", importOptions = ImportOption.DoNotIncludeTests.class)
class HexagonalArchitectureTest {
    ...
    static final ArchRule domain_must_not_depend_on_infrastructure = noClasses()
            ...
            .should()
            .dependOnClassesThat()
            .resideInAnyPackage("..infrastructure..", "..web..", "..persistence..", "..messaging..")
    ...
    @ArchTest
    static final ArchRule domain_must_not_use_jpa = noClasses()
            .that()
            .resideInAPackage("..domain..")
            .should()
            .dependOnClassesThat()
    ...
    @ArchTest
    static final ArchRule controllers_must_use_ports_not_services = noClasses()
            .that()
            ...
            .because(
                    "Les controllers doivent dépendre des interfaces (ports), " + "pas des implémentations (services). "
                            + "Utilise le port in: RegisterAgencyUseCase, pas RegisterAgencyService.");

    // ── Règle 5 : Les adapters implémentent les ports ─────────
    @ArchTest
    static final ArchRule adapters_must_implement_ports = classes()
            .that()
            .resideInAPackage("..persistence.adapter..")
            .should()
            .implement(com.tngtech.archunit.base.DescribedPredicate.describe(
                    "un port out du domaine", clazz -> clazz.getPackageName().contains("domain.port.out")))
    ...
    @ArchTest
    static final ArchRule jpa_entities_stay_in_infrastructure = classes()
            .that()
            .resideInAPackage("..persistence.entity..")
            .should()
            .resideInAPackage("..infrastructure..")
            .because("Les entités JPA sont un détail d'implémentation. " + "Seule l'infrastructure les connaît.");
}
