package cm.jemil.agency.adpater.outbound.persistence.adapter;
...
import cm.jemil.agency.adpater.outbound.persistence.entity.RouteJpaEntity;
import cm.jemil.agency.adpater.outbound.persistence.repository.AgencyJpaRepository;
...
public class AgencyRepositoryAdapter implements AgencyRepository {
    ...
    public boolean existsByNameAndCity(String name, String city) {
        return jpaRepository.existsByNameIgnoreCaseAndCityIgnoreCase(name, city);
    }
